...
The purpose of the project is to answer questions using data collected from a [FitBit]. (http://en.wikipedia.org/wiki/Fitbit)
...
The maximum number of steps in the 5-minute intervals is `r max_interval`.
